...
Depth maps are resized with nearest-neighbor interpolation: metric values interpolated across object boundaries would fabricate 3D points that exist nowhere in the scene.
