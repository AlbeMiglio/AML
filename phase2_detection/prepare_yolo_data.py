...
# Output path for the YOLO-ready dataset. Overridable so the derived copy can be
# written to scratch storage when the working volume cannot hold both.
...
def main():
    ...
    # Get the official per-object splits
    ...
    # Wipe, don't overwrite: a frame assigned to a different split across two runs
    # would otherwise be left behind in its previous split folder.
